...
######################################################################
LoadISISNexus(Filename=r'/home/tianhl/workarea/Data/CSNS_REFL_SIM/app/test/refl_sample_0.3.nxs',OutputWorkspace='refl_samp_0.3')
# theta=0.3 detector
import math
theta=0.3
...
ConvertUnits(InputWorkspace='detector_ws_orig_corr',OutputWorkspace='detector_ws',Target='Wavelength')
