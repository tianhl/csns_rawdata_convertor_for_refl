...
CropWorkspace(InputWorkspace='test',OutputWorkspace='detector_ws_orig',StartWorkspaceIndex='3',EndWorkspaceIndex='3')
...
# monitor
CropWorkspace(InputWorkspace='test',OutputWorkspace='monitor',StartWorkspaceIndex='0',EndWorkspaceIndex='0')
